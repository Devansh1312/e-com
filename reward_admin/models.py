...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    email = models.EmailField(null=True, blank=True, unique=True, db_index=True)  # Add index for email searches
    phone = models.CharField(max_length=20, db_index=True)  # Add index for phone searches
...
class SystemSettings(models.Model):
    ...
    telegram_link = models.TextField(null=True, blank=True)
...
class product(models.Model):
    name = models.CharField(max_length=255, null=True, blank=True, db_index=True)  # Add index for name searches
    category = models.ForeignKey(product_category, on_delete=models.CASCADE, related_name='products')
    description = models.TextField(null=True, blank=True)
    MRP = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    sale_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, db_index=True)  # Add index for price sorting
    ...
    status = models.BooleanField(default=True, help_text='0 = InActive | 1 = Active', db_index=True)  # Add index for status filtering
    url = models.URLField(null=True, blank=True)
    youtube_url = models.URLField(null=True, blank=True, help_text='YouTube video URL for this product')
    created_at = models.DateTimeField(auto_now_add=True, null=True, blank=True, db_index=True)  # Add index for date sorting
    updated_at = models.DateTimeField(auto_now=True, null=True, blank=True)  
    def __str__(self):
        return self.name
...
class product_variant(models.Model):
    ...
    MRP = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, help_text='Maximum Retail Price for this variant')
