...
(function () {
  ...
  for (const param of params) {
    if (param[0] == "layout_type") {
      localStorage.setItem("layout_type", param[1]);
      type = typeMap[param[1]];
    } 
  }
  var layoutInLocal = localStorage.getItem("layout_type");

  if (layoutInLocal) {
    type = typeMap[layoutInLocal];
  }
  var boxed = "";
...
$(document).ready(function () {
  $(".customizer-color li").on("click", function () {
    ...
    $("#color").attr(
      "href",
      "/cuba/cubaapp/static/assets/css/" + color + ".css"
    );
  ...
  $(".sidebar-type li").on("click", function () {
    ...
    switch (type) {
      ...
      case "normal-sidebar": {
        $(".logo-wrapper")
          .find("img")
          .attr("src", "/cuba/cubaapp/static/assets/images/logo/logo.png");
